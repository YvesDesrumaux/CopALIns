...
codeunit [ObjectID] "[Prefix]_[EntityName]Mgt"
{
    ...
    procedure Create[EntityName](var [EntityName]: Record "[Prefix]_[EntityName]"; [KeyParameters]: Text): Boolean
    var
        Handled: Boolean;
    begin
    ...
    procedure Update[EntityName](var [EntityName]: Record "[Prefix]_[EntityName]"; UpdateData: Record "[Prefix]_[EntityName]"): Boolean
    var
        Handled: Boolean;
    begin
    ...
    local procedure DoUpdate[EntityName](var [EntityName]: Record "[Prefix]_[EntityName]"; UpdateData: Record "[Prefix]_[EntityName]"; var Handled: Boolean)
    begin
        if Handled then
            exit;
    ...
    procedure Delete[EntityName](var [EntityName]: Record "[Prefix]_[EntityName]"): Boolean
    var
        Handled: Boolean;
    begin
    ...
    local procedure DoDelete[EntityName](var [EntityName]: Record "[Prefix]_[EntityName]"; var Handled: Boolean)
    begin
        if Handled then
            exit;
    ...
    procedure Get[EntityName]Statistics([EntityName]No: Code[20]; var Statistics: Record "[Prefix]_[EntityName] Statistics" temporary)
    begin
    ...
    procedure Process[EntityName]Batch(var [EntityName]: Record "[Prefix]_[EntityName]")
    var
    ...
    local procedure Process[EntityName]Record(var [EntityName]: Record "[Prefix]_[EntityName]")
    begin
    ...
    var
        ...
        [EntityName]Setup: Record "[Prefix]_[EntityName] Setup";
    begin
    ...
    local procedure IsValid[EntityName]([EntityName]: Record "[Prefix]_[EntityName]"): Boolean
    begin
    ...
    local procedure CanDelete[EntityName]([EntityName]: Record "[Prefix]_[EntityName]"): Boolean
    var
    ...
    var
        [EntityName]: Record "[Prefix]_[EntityName]";
    begin
    ...
    [BusinessEvent(false)]
    local procedure OnBeforeCreate[EntityName](var [EntityName]: Record "[Prefix]_[EntityName]"; [KeyParameters]: Text; var Handled: Boolean)
    begin
    end;

    [BusinessEvent(false)]
    local procedure OnAfterCreate[EntityName](var [EntityName]: Record "[Prefix]_[EntityName]")
    begin
    end;

    [BusinessEvent(false)]
    local procedure OnBeforeUpdate[EntityName](var [EntityName]: Record "[Prefix]_[EntityName]"; UpdateData: Record "[Prefix]_[EntityName]"; var Handled: Boolean)
    begin
    end;

    [BusinessEvent(false)]
    local procedure OnAfterUpdate[EntityName](var [EntityName]: Record "[Prefix]_[EntityName]")
    begin
    end;

    [BusinessEvent(false)]
    local procedure OnBeforeDelete[EntityName](var [EntityName]: Record "[Prefix]_[EntityName]"; var Handled: Boolean)
    begin
    end;

    [BusinessEvent(false)]
    local procedure OnAfterDelete[EntityName](var [EntityName]: Record "[Prefix]_[EntityName]")
    begin
    end;

    // Event subscribers for standard table events
    [EventSubscriber(ObjectType::Table, Database::"[Prefix]_[EntityName]", 'OnAfterInsertEvent', '', false, false)]
    local procedure OnAfterInsert[EntityName](var Rec: Record "[Prefix]_[EntityName]")
    begin
    ...
    [EventSubscriber(ObjectType::Table, Database::"[Prefix]_[EntityName]", 'OnAfterModifyEvent', '', false, false)]
    local procedure OnAfterModify[EntityName](var Rec: Record "[Prefix]_[EntityName]")
    begin
        // Handle post-modify operations
        UpdateRelatedRecords(Rec);
    end;

    local procedure UpdateRelatedRecords([EntityName]: Record "[Prefix]_[EntityName]")
    var
        RelatedRecord: Record "[Related Table]";
    begin
        RelatedRecord.SetRange("[Key Field]", [EntityName]."No.");
...
codeunit [ObjectID] "[Prefix]_[EntityName] Workflow"
{
    ...
    procedure Execute[EntityName]Workflow(var [EntityName]: Record "[Prefix]_[EntityName]")
    var
        Handled: Boolean;
    begin
    ...
    local procedure DoExecute[EntityName]Workflow(var [EntityName]: Record "[Prefix]_[EntityName]"; var Handled: Boolean)
    var
        [EntityName]Mgt: Codeunit "[Prefix]_[EntityName] Mgt";
    ...
    local procedure ValidateWorkflowPreconditions(var [EntityName]: Record "[Prefix]_[EntityName]"; WorkflowStage: Integer)
    var
        [EntityName]Mgt: Codeunit "[Prefix]_[EntityName] Mgt";
    begin
    ...
    local procedure ProcessBusinessLogic(var [EntityName]: Record "[Prefix]_[EntityName]"; WorkflowStage: Integer)
    begin
    ...
    local procedure FinalizeWorkflow(var [EntityName]: Record "[Prefix]_[EntityName]"; WorkflowStage: Integer)
    begin
    ...
    local procedure ProcessActiveEntity(var [EntityName]: Record "[Prefix]_[EntityName]")
    begin
        // Processing logic for active entities
    end;

    local procedure ProcessInactiveEntity(var [EntityName]: Record "[Prefix]_[EntityName]")
    begin
        // Processing logic for inactive entities
    end;

    local procedure UpdateWorkflowProgress([EntityName]: Record "[Prefix]_[EntityName]"; Stage: Integer; Message: Text)
    begin
        if IsGuiAllowed() then
            Window.Update(1, StrSubstNo('Stage %1: %2', Stage, Message));
    end;

    local procedure SendWorkflowNotification([EntityName]: Record "[Prefix]_[EntityName]")
    begin
        if IsGuiAllowed() then
    ...
    [BusinessEvent(false)]
    local procedure OnBeforeExecute[EntityName]Workflow(var [EntityName]: Record "[Prefix]_[EntityName]"; var Handled: Boolean)
    begin
    end;

    [BusinessEvent(false)]
    local procedure OnAfterExecute[EntityName]Workflow(var [EntityName]: Record "[Prefix]_[EntityName]")
    begin
    end;

    [IntegrationEvent(false, false)]
    procedure OnAfterWorkflowCompleted([EntityName]: Record "[Prefix]_[EntityName]")
    begin
    end;
}