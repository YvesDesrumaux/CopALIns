...
page [ObjectID] "[Prefix]_[EntityName] Card"
{
    ...
    PageType = Card;
    SourceTable = "[Prefix]_[EntityName]";
    UsageCategory = None;
    ApplicationArea = All;
    ...
    actions
    {
        area(Processing)
        {
            ...
            action(Copy)
            {
                ...
                trigger OnAction()
                var
                    NewRecord: Record "[Prefix]_[EntityName]";
                    [EntityName]Card: Page "[Prefix]_[EntityName] Card";
                begin
        ...
        area(Reporting)
        {
            action(PrintRecord)
            {
                ...
                trigger OnAction()
                begin
                    Report.RunModal(Report::"[Prefix]_[EntityName] Document", true, true, Rec);
                end;
            }
        }
        area(Promoted)
...
page [ObjectID] "[Prefix]_[EntityName] List"
{
    ...
    UsageCategory = Lists;
    ApplicationArea = All;
    CardPageId = "[Prefix]_[EntityName] Card";
    Editable = false;
    ...
    actions
    {
        area(Processing)
        {
            ...
            action(BulkActivate)
            {
                ...
                trigger OnAction()
                var
                    SelectedRecord: Record "[Prefix]_[EntityName]";
                begin
        ...
        area(Reporting)
        {
            action(PrintList)
            {
                ...
                begin
                    CurrPage.SetSelectionFilter(SelectedRecord);
                    Report.RunModal(Report::"[Prefix]_[EntityName] List", true, true, SelectedRecord);
                end;
            }
            action(ExportToExcel)
            {
                ...
                begin
                    CurrPage.SetSelectionFilter(SelectedRecord);
                    Report.RunModal(Report::"[Prefix]_[EntityName] Export", true, false, SelectedRecord);
                end;
            }
        }
        area(Promoted)
