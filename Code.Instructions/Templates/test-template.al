...
codeunit [ObjectID] "X [Prefix]_[EntityName] Tests"
{
    ...
    var
        [EntityName], UpdateData: Record "[Prefix]_[EntityName]";
    ...
    var
        [EntityName]: Record "[Prefix]_[EntityName]";
        Statistics: Record "[Prefix]_[EntityName] Statistics" temporary;
        RelatedRecord: Record "[Related Table]";
        i: Integer;
    begin
        // Arrange
    ...
    var
        [EntityName]: Record "[Prefix]_[EntityName]";
        [EntityName]1, [EntityName]2, [EntityName]3: Record "[Prefix]_[EntityName]";
    begin
        // Arrange
        Initialize();
    ...
    var
        [EntityName]: Record "[Prefix]_[EntityName]";
        [EntityName]Workflow: Codeunit "[Prefix]_[EntityName] Workflow";
        OriginalStatus: Enum "[Prefix]_[EntityName] Status";
    begin
        // Arrange
        Initialize();
        CreateTest[EntityName]([EntityName]);
    ...
    local procedure CreateTest[EntityName](var [EntityName]: Record "[Prefix]_[EntityName]")
    begin
        [EntityName].Init();
        [EntityName]."No." := 'X' + LibraryUtility.GenerateRandomCode([EntityName].FieldNo("No."), Database::"[Prefix]_[EntityName]");
    ...
    [ModalPageHandler]
    procedure [EntityName]CardHandler(var [EntityName]Card: TestPage "[Prefix]_[EntityName] Card")
    begin
    ...
    [PageHandler]
    procedure [EntityName]ListHandler(var [EntityName]List: TestPage "[Prefix]_[EntityName] List")
    begin
