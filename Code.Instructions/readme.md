...
- [➡️ Design Patterns](./DesignPatterns/) This section will cover patterns that solve certain design challenges in Business Central.
- [➡️ Best Practices](./BestPractices/) This section will be cover things that aren’t as simple as Design Patterns, but will help make sure the development is:
  - high-performance
